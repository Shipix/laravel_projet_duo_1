...
Route::get('/article-show/{id}', [ShowController::class, 'show'])->name('show');
Route::get('/article-edit/{id}', [EditController::class, "edit"])->name('edit');
...
Route::post('/article-update/{id}', [EditController::class, "update"]);
